...
const upload = () => {
  ...
  return (
    <div className='flex w-full h-full absolute left-0 top-[60px] mb-10 lg:pt-20 bg-[#F8F8F8] justify-center'>
      <div className='bg-white rounded-lg xl:h-[80vh] flex 
      w-[80%]
      gap-6 flex-wrap justify-between items-center p-14 pt-6'>
        <div>
          <div>
                ...
                {videoAsset ? (
                  ...
                  <label className='cursor-pointer'>
                    <div className='flex flex-col items-center justify-center h-full'>
                      ...
                      <p className='bg-[#F51997]
                      text-center mt-10 rounded text-white text-md font-medium
